...
def main():
    ...
    schema = {
        ...
        "properties": {
            ...
            "blockers": {"type": "array", "items": {"type": "string", "enum": response_contract["allowed_blockers"]}, "uniqueItems": True},
            "verdict": {"type": "string", "enum": response_contract["allowed_verdicts"]},
            "evidence": {"type": "array", "items": {"type": "string", "enum": response_contract["evidence_ids"]}, "uniqueItems": True},
        },
