#!/usr/bin/env python3
"""Independent defect-injection controls for Context Capsule v1.

This is deliberately separate from capsule content: the expected material IDs below
are a test oracle, not a production semantic registry. The production validator
must not let a capsule define the universe used to prove its own completeness.
"""
