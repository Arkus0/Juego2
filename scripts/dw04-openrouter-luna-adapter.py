...
FACT_DOMAINS = {
    ...
    "x6_access": ["AX1", "AX2", "AX3", "AX4", "AX5", "AX6", "AX7"],
    "x6_cart_authorized": ["YES", "NO"],
    "x6_bicycle_authorized": ["YES", "NO"],
    "access_layers": [
        "public + service + semi-private layers",
        "public",
        "public passage + semi-private court",
        "private thresholds",
        "public + staff/service + private records layer",
        "public + service + private work layer",
        "public + private staff/storage",
        "public + service",
        "frontage + private upper thresholds",
        "inaccessible shell",
        "private + semi-private + public threshold",
        "public/semi-private edge",
        "private threshold",
        "semi-private + public edge",
        "public/customer threshold + service + private work layer"
    ],
    "actor_visible_stale_label": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "automatic_truth_belief_sync": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "nc02_behavior_neutral": ["REQUIRED", "NOT_REQUIRED"],
    "recursive_hidden_lineage": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "nc02_invariance": ["REQUIRED", "NOT_REQUIRED"],
    "receiver_epistemic_owner": ["PA-01", "PA-02", "PA-03", "PA-04", "PA-05"],
    "DL-11": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "DL-12": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "DL-13": ["ADOPT", "ADAPT", "REJECT", "LATER"],
    "DL-14": ["ADOPT", "ADAPT", "REJECT", "LATER"],
}
