...
case "$(resolve_wp)" in
  WP-DW-GATE)
    exec bash scripts/dwgate-observe-exact-sha.sh "$@"
    ;;
  WP-DW-05)
    exec bash scripts/dw05-observe-exact-sha.sh "$@"
    ;;
  WP-DW-04)
    exec bash scripts/dw04-observe-exact-sha.sh "$@"
    ;;
  WP-DW-03)
    exec bash scripts/dw03-observe-exact-sha.sh "$@"
    ;;
  WP-DW-02)
    exec bash scripts/dw02-observe-exact-sha.sh "$@"
    ;;
  WP-DW-01)
  ...
  WP-DW-00)
    ...
    ;;
  WP-H1-02)
    exec bash scripts/h1-02-observe-exact-sha.sh "$@"
    ;;
  WP-H1-01)
