...
namespace Arkus.HK00.Proof
{
    ...
    internal static class FixedContract
    {
        ...
        public static readonly IReadOnlyList<ProjectSpec> Projects = new[]
        {
            ...
            new ProjectSpec("Arkus.Game.Authoring", "src/Arkus.Game.Authoring/Arkus.Game.Authoring.csproj", ProjectKind.Portable, new[] { "Arkus.Game.Core", "Arkus.Game.Validation", "Arkus.Game.World", "Arkus.Harness.Protocol" }, Array.Empty<string>()),
            ...
            new ProjectSpec("Arkus.Harness.Runtime", "src/Arkus.Harness.Runtime/Arkus.Harness.Runtime.csproj", ProjectKind.Portable, new[] { "Arkus.Game.Authoring", "Arkus.Game.Validation", "Arkus.Game.World", "Arkus.Harness.Protocol" }, Array.Empty<string>()),
            new ProjectSpec("Arkus.Harness.Projection", "src/Arkus.Harness.Projection/Arkus.Harness.Projection.csproj", ProjectKind.Portable, new[] { "Arkus.Harness.Protocol", "Arkus.Harness.Runtime" }, Array.Empty<string>()),
            new ProjectSpec("Arkus.Harness.Cli", "src/Arkus.Harness.Cli/Arkus.Harness.Cli.csproj", ProjectKind.Host, new[] { "Arkus.Harness.Projection", "Arkus.Harness.Protocol" }, Array.Empty<string>()),
            new ProjectSpec("Arkus.Harness.MutationAttackFixture", "tests/Arkus.Harness.MutationAttackFixture/Arkus.Harness.MutationAttackFixture.csproj", ProjectKind.Proof, new[] { "Arkus.Game.Authoring", "Arkus.Harness.Protocol", "Arkus.Harness.Runtime" }, Array.Empty<string>()),
            new ProjectSpec("Arkus.Harness.Tests", "tests/Arkus.Harness.Tests/Arkus.Harness.Tests.csproj", ProjectKind.Tests, new[] { "Arkus.Game.Authoring", "Arkus.Game.Core", "Arkus.Game.Validation", "Arkus.Game.World", "Arkus.Harness.MutationAttackFixture", "Arkus.Harness.Projection", "Arkus.Harness.Protocol", "Arkus.Harness.Runtime" }, new[] { "Microsoft.NET.Test.Sdk", "xunit.core", "xunit.assert", "xunit.runner.visualstudio" }),
