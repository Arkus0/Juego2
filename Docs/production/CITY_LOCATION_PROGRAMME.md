...
| `loc.ribera.service_yard` | Ribera y Talleres | storage / delivery yard | `W.RIBERA`, service relation toward `W17` | work, logistics | **B** | **S2** | **I1** | service-first, conditional public edge | goods movement, delivery/collection, changing material state |
...
| `loc.ribera.service_yard` | workers/delivery roles; work/arrival bands | storage, delivery, collection | material/witness surface | respects service access; `AS` is not ordinary-public proof | I1 | goods/material occupation | logistics exists as ordinary town function |
