...
PA research can inform later H2+ design but cannot claim runtime/Unity proof or silently alter H0/H1/CITY contracts. The next executable PA workpack is `WP-PA-03 — Adopt/revalidate Social Graph findings`; after PA-01..05 are accepted in Juego2, the first genuinely new research workpack is `WP-PA-06 — Memory & Consequences research`.
