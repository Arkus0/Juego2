...
1. Adopt play-design rules PD-01..PD-15 (or a reviewed revision) as CITY-owned acceptance vocabulary.
2. Produce explicit, owner-tagged amendment deltas for the seed proposals P1–P7:
   ...
   - `CITY-02`: add Bolera del Puente as a B/S2/I0 place;
   - `CITY-03`: walkway authorization inside `nb.rio_bank` for the paseo only; new open-site region `S04` on Orilla sur; F02 landmark posture; the five postcard camera positions;
...
- updated figure `Docs/production/figures/city_seed_play_layer.svg`.
