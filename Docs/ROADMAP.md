...
Next dependency-valid workpack after the verified content-shape decision: `WP-HK-02A`.
...
| 7 | `WP-HK-02A` | Object-scoped extension data + typed dependency references propagated through HK03/HK04 |
