...
- **Authored versus live time:** the canonical state here describes authored schedule data, not a ticking simulation. `WP-HK-06` now owns the explicit authored-state snapshot/journal boundary; live clock, transient NPC position and deterministic simulation remain outside HK02A.
