# H0S-00 — Initial synthetic structural viability spike
...
The semantic result can remain identical while the work shape changes from global-population dependent to relevant-source dependent. This directly matches PA-02's anti-global-scan/irrelevant-decoy requirement and provides an H0S fixture family for SV-1.
...
- `Docs/workpacks/H0S/WP-H0S-00.md` owns the early deterministic structural falsification spike.
- `Docs/workpacks/PA/WP-PA-13.md` carries SV-1/SV-2 into the simulation-control/failure-mode synthesis.
