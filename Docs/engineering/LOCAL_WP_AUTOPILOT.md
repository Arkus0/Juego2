...
| Material-FAIL audit | GPT-6 Luna xhigh | Checks circuit breakers at every FAIL; at the second FAIL classifies concrete valid defect, overdefense or uncertainty. Never emits/supersedes a verdict. |
