...
The rows below are direct transcriptions of the residual boundary declared by accepted `WP-CITY-02` candidate `ddcb22d9a2dfcf68054db2b762fc7ff7aed68ae8` (PASS `#5266113192`). They are not part of the 53-row H0 closure universe and carry no HK10/HK-GATE classification.

| ID | Declared by | Residual | Owner | Status |
|---|---|---|---|---|
| `R-CITY02-01` | CITY-02 | Exact parcel/site placement, exact footprint/frontage dimensions and shell composition remain unproved by the place programme | CITY-05 | `DEFERRED` |
| `R-CITY02-02` | CITY-02 | Exact interior layouts and layered discovery routes remain downstream of the interior-priority backlog | CITY-06 | `DEFERRED` |
| `R-CITY02-03` | CITY-02 | Exact retained-seed boundary/selection remains unchosen | CITY-03 | `DEFERRED` |
| `R-CITY02-04` | CITY-02 | Realized blockout traversal/reactive-density measurements are not yet available; full-city physical measurements remain unavailable until sufficient realized geometry has an accepted owner | CITY-04 for the accepted seed; later realized-geometry owner for broader measurements | `DEFERRED` |
| `R-CITY02-05` | CITY-02 | Runtime schedules, beliefs, dialogue, relationships, decisions, incidents and off-screen simulation are not authored by the spatial programme | Living World / runtime owners | `DEFERRED` |
| `R-CITY02-06` | CITY-02 | Final runtime IDs/NPC bindings, narrative/backstories, minigame mechanics and State-1→State-2 production timing remain outside CITY-02 | later product/runtime/production owners | `DEFERRED` |

The CITY-02 Q6 class-ceiling/reserve rule is **not** a residual: it is an accepted fail/reopen condition. If downstream composition exceeds a programme envelope, breaches a district cap or needs protected reserve, Q6 must reopen rather than being recorded as deferred success.
